...
export default function TaskApp() {
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", minHeight: "100vh", fontFamily: "Inter, system-ui, sans-serif" }}>
      <Sidebar
        active={filter}
        counts={counts}
      ...
      <main style={{ maxWidth: "60%", width: "60%", margin: "0 auto", padding: "24px 24px", marginTop: "20vh" }}>
